...
public class PieceControleur {
	 ...
	 * 
	 * <p>Vérifie si le joueur actuel peut manipuler la pièce cliquée. 
	 * Si oui, sélectionne ou désélectionne la pièce
    ...
    public void handleMouseClick(Piece piece, Plateau plateau) {
	        if (plateau.getUtilisateur().getTourJoueur() == 
